...
class ToolsUi(QDialog):
    ...
    def ui_translate(self):
        ...
        self.setWindowTitle(self._translate("TCP-UDP", "内网扫描客户端-窗口%s" % self.num))
        ...
        self.label_send.setText(self._translate("TCP-UDP", "自定义内网地址"))
        self.label_dir.setText(self._translate("TCP-UDP", "请选择index.html所在的文件夹"))
        self.label_written.setText(self._translate("TCP-UDP", "Written by ysf"))
    ...
    def combobox_change(self):
        ...
        if self.comboBox_tcp.currentIndex() == 1 or self.comboBox_tcp.currentIndex() == 3:
            self.textEdit_send.setText("192.168.0.0/16")
